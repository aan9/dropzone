    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">Cari Produk Ore Lain</div>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading"><b>Manage My Products</b></div>

                <div class="panel-body">

                    @role('members')
                    <a href="{{ route('products.create') }}" class="btn btn-warning">Create My Product</a>
                    @endrole
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST" action="{{ route('products.destroy',$product->id) }}">
                                        ...
                                        <a href="{{ route('products.edit',$product->id) }}" class="btn btn-info btn-mini">Edit</a>
